    ...
    [
      path.resolve(__dirname, './src/plugin/plugin-content-blog'), {
        ...
        editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
          `https://github.com/xvtx/blog/edit/main/${blogDirPath}/${blogPath}`,
        ...
        feedOptions: {
          type: 'all',
          title: '小微',
          copyright: `Copyright © ${new Date().getFullYear()} 小微 Built with Docusaurus.<p><a href="http://beian.miit.gov.cn/" class="footer_lin">${beian}</a></p>`,
        },
      }
    ],
    // ...
