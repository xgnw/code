...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        case "1":
            ...
            $('#bg').attr('src', 'https://api.dujin.org/bing/1920.php') //随机默认壁纸
            break;
        case "2":
            $('#bg').attr('src', 'https://api.dujin.org/bing/1920.php') //必应每日
            break;
        case "3":
            $('#bg').attr('src', 'https://api.dujin.org/bing/1920.php') //随机风景
            break;
        case "4":
            $('#bg').attr('src', 'https://api.dujin.org/bing/1920.php') //随机二次元
            break;
        case "5":
