...
Else
	...
	Set mRs=nothing
	End If
	Response.Write "<script>alert('修改成功');this.location.href='geren.asp';</SCRIPT>"
End If
%>
<%
'删除
...
Else
	...
	Set mRs=nothing
	End If
	Response.Write "<script>alert('删除成功');this.location.href='geren.asp';</SCRIPT>"
End If
%>
<html>
<head>
		...
		<td valign="top" bgcolor="#FFFFFF">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<p align="center">&nbsp;·&nbsp;个人出售&nbsp;·<%
Set mRs=Server.CreateObject("adodb.recordSet")
Sql="Select * from DYQQ where DYQQ_tuijian = 0 and DYQQ_del = 0 order by id desc"
