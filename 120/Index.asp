...
<title>第一QQ dyqq.cn │QQ│QQ号│QQ号码│QQ号码交易中心</title>
...
Sql="Select * from DYQQ where DYQQ_del = 0 and DYQQ_tuijian = 0 order by id desc"
mRs.open Sql,conn,1,1
If mRs.bof and mRs.eof then
	Response.Write"<script>alert('没有QQ号码!!添加后将会恢复正常');this.location.href='add.asp';</Script>"
Else
...
<td width="8%" align="center"><a href="qq.asp?id=<%=mRs("id")%>" target="_blank"><font color="#0099ff">查看详细</font></a></td></td>
</tr>
</table>
<%
i=i+1
